...
def run(rank, n_gpus, hps):
  ...
  # dist.init_process_group(backend='nccl', init_method='env://', world_size=n_gpus, rank=rank)    dist.init_process_group(backend='gloo', init_method='env://', world_size=n_gpus, rank=rank)
